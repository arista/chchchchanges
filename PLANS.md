...
This will be a TypeScript library project.  Set up the typical scaffolding according to modern best practices.  Create a DEVELOPMENT.md that lists the various operations and commands typically used during development cycle.  Include a link to DEVELOPMENT.md in CLAUDE.md, so that you have a sense of what to do in the future.

Do all this on a new nsa-ts-scaffold branch
